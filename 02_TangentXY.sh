...
usage() {
	...
	echo "  NormalsMatrix: Normal sample transformed signal matrix file generated by 01_PreprocessNormals.sh."
	echo "  NormalsTransformedMatrix: RData file generated by 01_PreprocessNormals.sh."
	echo "  TumorMatrix: Tumor sample transformed signal matrix file generated by 01_PreprocessNormals.sh."
